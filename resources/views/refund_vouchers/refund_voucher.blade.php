		...
		<div class="panel-body">
			...
			<fieldset>
				<div class="form-group col-sm-3">
					...
					<div class="bfh-datepicker" data-name="posting_date" data-format="d-m-y" data-date="today">
						<div class="input-group bfh-datepicker-toggle" data-toggle="bfh-datepicker">
							<span class="input-group-addon"><i class="glyphicon glyphicon-calendar"></i></span>
							<input type="text" name="posting_date" class="form-control" placeholder="" readonly="">
						</div>
					</div>
				</div>
