...
class VoucherController extends Controller
{
    ...
    // view refund vouchers
    public function refund_voucher()
    {
        // Get all parties
        $party_data = new Party;
        $arrayParties = $party_data->all_parties(2);
        return View('refund_vouchers.refund_voucher', compact('arrayParties'));
    }
    ...
    public function create()
    {
        ...
        $data->posting_date = date("Y-m-d", strtotime(Input::get('posting_date')));
        
        $data->tax = Input::get('voucher_type');
    ...
    public function create_refund()
    {
        ...
        if($data->save()){
            ...
            Session::flash('sale_voucher_message', "Refund voucher added successfully!");
            return Redirect::back();
        }
        else{
            return Redirect::back()->with('error', 'Error message');;
    ...
    public function list_sale_voucher()
    {
        ...
        $arrayVouchers = $voucher_data->all_vouchers("SV");
        return View('vouchers.list_sale_voucher', compact('arrayVouchers'));
    }

    public function list_refund_voucher()
    {
        $voucher_data = new Voucher;
        $arrayVouchers = $voucher_data->all_vouchers("RV");
        return View('refund_vouchers.list_refund_voucher', compact('arrayVouchers'));
    }
